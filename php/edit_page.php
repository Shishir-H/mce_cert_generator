...
<body>
    ...
    <div class="container mt-10">
        <form action="./editpdf.php" method="post" id="form" class="form" style = "width:90%">
...
<table class = "table" style = "align:center;margin-left:auto;margin-right:auto;" id="expenditure_table">
                        ...
                        <tr>
                            <td>Tuition fee</td>
                            <td><input type="text" class="form-control" value="15000" name="tut_fee1"></input></td>
                            <td><input type="text" class="form-control" value="15000" name="tut_fee2"></input></td>
                            <td><input type="text" class="form-control" value="15000" name="tut_fee3"></input></td>
                            <td><input type="text" class="form-control" value="15000" name="tut_fee4"></input></td>
                            
                        </tr>
                            <tr>
                            <td>Other Fee (Exam Fee +University Reg Fee+Other University Fee</td>
                            <td><input type="text" class="form-control" value="7310" name="ex_fee1"></input></td>
                            <td><input type="text" class="form-control" value="4650" name="ex_fee2"></input></td>
                            <td><input type="text" class="form-control" value="4650" name="ex_fee3"></input></td>
                            <td><input type="text" class="form-control" value="4650" name="ex_fee4"></input></td>
                       </tr>
                        <tr>
                            <td>MTES (R) Corpus Fund (Tentative)</td>
                            <td><input type="text" class="form-control" value="18000" name="corp_fee1"></input></td>
                            <td><input type="text" class="form-control" value="16000" name="corp_fee2"></input></td>
                            <td><input type="text" class="form-control" value="16000" name="corp_fee3"></input></td>
                            <td><input type="text" class="form-control" value="16000" name="corp_fee4"></input></td>
                        </tr>
                        <tr>
                            <td>Books</td>
                            <td><input type="text" class="form-control" value="10000" name="book_fee1"></input></td>
                            <td><input type="text" class="form-control" value="10000" name="book_fee2"></input></td>
                            <td><input type="text" class="form-control" value="10000" name="book_fee3"></input></td>
                            <td><input type="text" class="form-control" value="10000" name="book_fee4"></input></td>
                        </tr>
                        <tr>
                            <td>Drawing Board, Drafter, Calculator & Accessories</td>
                            <td><input type="text" class="form-control" value="10000" name="acc_fee1"></input></td>
                            <td><input type="text" class="form-control" value="0" name="acc_fee2"></input></td>
                            <td><input type="text" class="form-control" value="0" name="acc_fee3"></input></td>
                            <td><input type="text" class="form-control" value="0" name="acc_fee4"></input></td>
                        </tr>
                        <tr>
                            <td>Computer / Laptop</td>
                            <td><input type="text" class="form-control" value="45000" name="lap_fee1"></input></td>
                            <td><input type="text" class="form-control" value="0" name="lap_fee2"></input></td>
                            <td><input type="text" class="form-control" value="0" name="lap_fee3"></input></td>
                            <td><input type="text" class="form-control" value="0" name="lap_fee4"></input></td>
                        </tr>
                        <tr>
                            <td>Project</td>
                            <td><input type="text" class="form-control" value="0" name="proj_fee1"></input></td>
                            <td><input type="text" class="form-control" value="0" name="proj_fee2"></input></td>
                            <td><input type="text" class="form-control" value="0" name="proj_fee3"></input></td>
                            <td><input type="text" class="form-control" value="15000" name="proj_fee4"></input></td>
                        </tr>
                        <tr>
                            <td><span>Total<span></td>
                            <td><input type="text" class="form-control" value="105310.00" name="tot_fee1"></input></td>
                            <td><input type="text" class="form-control" value="45650.00" name="tot_fee2"></input></td>
                            <td><input type="text" class="form-control" value="45650.00" name="tot_fee3"></input></td>
